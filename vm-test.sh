...
declare -A NOTE=(
  ...
  [67-herdr-integrations.sh]="instala hooks de sessão; sem profiles ainda, fecha limpo"
  [68-pidbox.sh]="autocontido, e ainda prova a contenção com --check-hard"
  [69-herdr-profile-switch.sh]="instala helper e keybinding Codex/Claude no herdr"
